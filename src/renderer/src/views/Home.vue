<template>
  <div class="flex h-screen w-screen home-background">
    ...
    <aside class="w-64 bg-white dark:bg-gray-800 shadow-xl border-r border-gray-200 dark:border-gray-700 flex flex-col sidebar-style">
      ...
      <!-- 导航菜单 -->
      <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto"> <!-- 导航菜单容器 -->
        <div 
          class="menu-item-modern group" 
          :class="{ active: currentView === 'bookshelf' }"
          @click="currentView = 'bookshelf'"
        > <!-- 我的书架菜单项 -->
          <svg class="w-5 h-5 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"> <!-- 书架图标 -->
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" /> <!-- 图标路径 -->
          </svg> <!-- 图标结束 -->
          <span class="font-medium">我的书架</span> <!-- 菜单文本 -->
        </div> <!-- 菜单项结束 -->
        ...
        > <!-- 数据统计菜单项 -->
          <svg class="w-5 h-5 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"> <!-- 统计图标 -->
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" /> <!-- 图标路径 -->
          </svg> <!-- 图标结束 -->
          <span class="font-medium">数据统计</span> <!-- 菜单文本 -->
        </div> <!-- 菜单项结束 -->

        <div class="menu-item-modern group" @click="showSettingsDialog = true"> <!-- 系统设置菜单项 -->
          <svg class="w-5 h-5 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"> <!-- 设置图标 -->
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" /> <!-- 图标路径 -->
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /> <!-- 图标路径 -->
          </svg> <!-- 图标结束 -->
          <span class="font-medium">系统设置</span> <!-- 菜单文本 -->
        </div> <!-- 菜单项结束 -->

        <div class="menu-item-modern group" @click="handleOpenShortcutDialog"> <!-- 快捷键设置菜单项 -->
          <svg class="w-5 h-5 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"> <!-- 快捷键图标 -->
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4" /> <!-- 图标路径 -->
          </svg> <!-- 图标结束 -->
          <span class="font-medium">快捷键设置</span> <!-- 菜单文本 -->
        </div> <!-- 菜单项结束 -->

        <div class="menu-item-modern group" @click="showShelfPasswordDialog = true"> <!-- 书架密码菜单项 -->
          <svg class="w-5 h-5 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"> <!-- 密码图标 -->
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" /> <!-- 图标路径 -->
          </svg> <!-- 图标结束 -->
          <span class="font-medium">书架密码</span> <!-- 菜单文本 -->
        </div> <!-- 菜单项结束 -->

        <div class="menu-item-modern group" @click="goToUserGuide"> <!-- 写作指南菜单项 -->
          <svg class="w-5 h-5 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"> <!-- 指南图标 -->
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /> <!-- 图标路径 -->
          </svg> <!-- 图标结束 -->
          <span class="font-medium">写作指南</span> <!-- 菜单文本 -->
        </div> <!-- 菜单项结束 -->

        <div class="menu-item-modern group" @click="showHelpDialog = true"> <!-- 帮助中心菜单项 -->
          <svg class="w-5 h-5 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"> <!-- 帮助图标 -->
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /> <!-- 图标路径 -->
          </svg> <!-- 图标结束 -->
          <span class="font-medium">帮助中心</span> <!-- 菜单文本 -->
        </div> <!-- 菜单项结束 -->

        <div class="menu-item-modern group" @click="showSponsorDialog = true"> <!-- 赞助作者菜单项 -->
          <svg class="w-5 h-5 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"> <!-- 赞助图标 -->
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" /> <!-- 图标路径 -->
          </svg> <!-- 图标结束 -->
          <span class="font-medium">赞助作者</span> <!-- 菜单文本 -->
        </div> <!-- 菜单项结束 -->
      </nav>
    </aside>

    <!-- 主内容区 -->
    <Bookshelf v-if="currentView === 'bookshelf'" /> <!-- 显示书架视图 -->
    <Statistics v-else-if="currentView === 'statistics'" /> <!-- 显示统计视图 -->
...
import Statistics from '@renderer/components/Statistics.vue' // 导入统计组件
import { useThemeStore, THEME_CONFIGS } from '@renderer/stores/theme'
import { ElDialog, ElMessage } from 'element-plus'

const router = useRouter()
const currentView = ref('bookshelf') // 当前视图状态：bookshelf 或 statistics
